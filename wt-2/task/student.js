...
const spiData = [
  ...
  app.get('/student/greater/:spi',(req,res)=>{
    const spi = parseFloat(req.params.spi);
    const index = spiData.filter(student=>student.spi>spi );
  ...
  app.get('/student/less/:spi',(req,res)=>{
  ...
  app.get('/student/lang/:lang',(req,res)=>{
